...
namespace cAlgo.Robots
{
    ...
    public class JCAMP_FxScalper_V2 : Robot
    {
        ...
        private void UpdateH1LevelVisualization(double currentPrice)
        {
            ...
            CleanupOldLevelLines();

            // Get the closest levels to current price
            ...
            Print("[Visualization] Drew {0} support lines and {1} resistance lines",
                nearestSupports.Count, nearestResistances.Count);
        }
